DO $$
DECLARE 
  insert_username CONSTANT VARCHAR(100) := 'tom.watkins';
  forename CONSTANT VARCHAR(100) := 'Tom';
  surname CONSTANT VARCHAR(100) := 'Watkins';
  email CONSTANT VARCHAR(100) := 'tom.watkins@madetech.com';
