...
export default class CourtCase {
  ...
  hearingOutcomeJson!: AnnotatedHearingOutcome | null | PncUpdateDataset
  ...
  triggerQualityChecked!: null | TriggerQuality
  ...
  updatedHearingOutcomeJson!: AnnotatedHearingOutcome | null | PncUpdateDataset
