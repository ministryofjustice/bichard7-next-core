...
describe("generateWarrantsReport", () => {
  ...
  let mockUser: User
  let mockQuery: WarrantsReportQuery
  ...
  it("should successfully run the report, capture the total count, and call createReportAuditLog", async () => {
    ...
    const result = await generateWarrantsReport(mockDatabase, mockAuditLogGateway, mockUser, mockQuery, mockReply)
