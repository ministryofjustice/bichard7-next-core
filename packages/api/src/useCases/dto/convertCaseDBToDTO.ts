...
export const convertCaseDBToCaseDTO = (caseDB: PartialCaseRow, user: User, logger: FastifyBaseLogger): CaseDto => {
...
export const convertCaseDBToCasePartialDTO = (caseDb: PartialCaseRow, user: User): CasePartialDto => {
  return {
    asn: caseDb.asn,
