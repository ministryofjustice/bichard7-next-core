...
describe("errorStatusFromCaseDB", () => {
  it("returns Unresolved when errorStatus is null", () => {
    const caseDb = { error_status: null } as unknown as RawCaseData
  ...
  it("returns Unresolved when errorStatus is 1", () => {
    const caseDb = { error_status: 1 } as unknown as RawCaseData
  ...
  it("returns Resolved when errorStatus is 2", () => {
    const caseDb = { error_status: 2 } as unknown as RawCaseData
  ...
  it("returns Submitted when errorStatus is 3", () => {
    const caseDb = { error_status: 3 } as unknown as RawCaseData
...
describe("triggerStatusFromCaseDB", () => {
  it("returns Unresolved when errorStatus is null", () => {
    const caseDb = { trigger_status: null } as unknown as RawCaseData
  ...
  it("returns Unresolved when errorStatus is 1", () => {
    const caseDb = { trigger_status: 1 } as unknown as RawCaseData
  ...
  it("returns Resolved when errorStatus is 2", () => {
    const caseDb = { trigger_status: 2 } as unknown as RawCaseData
  ...
  it("returns Submitted when errorStatus is 3", () => {
    const caseDb = { trigger_status: 3 } as unknown as RawCaseData
