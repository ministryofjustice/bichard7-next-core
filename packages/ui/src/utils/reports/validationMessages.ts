...
export const DATE_SHOULD_BE_WITHIN_THE_LAST_12_MONTHS = "Date must be within the last 12 months"
export const DATE_EXCEEDS_MAX_RANGE = "Date to cannot be more than 1 month after date from"
