...
describe("groupErrorsFromReport", () => {
  it("can map all exceptions from the error report", () => {
    ...
    expect(groupErrorsFromReport(errorReport)).toStrictEqual({ HO100310: 1, HO100322: 1, HO100323: 1 })
  })
  ...
  it("can group multiple occurrences of a code", () => {
    ...
    expect(groupErrorsFromReport(errorReport)).toStrictEqual({ HO100310: 1, HO100322: 2 })
  })
})
