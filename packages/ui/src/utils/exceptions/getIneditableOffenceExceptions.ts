...
const getIneditableOffenceExceptions = (exceptions: Exception[]): Exception[] => {
  ...
  return exceptions.filter(({ code }) => ineditableOffenceExceptions.includes(code))
}

export default getIneditableOffenceExceptions
