...
const getOffenceExceptions = (exceptions: Exception[]): Exception[] => {
  const offenceExceptions = [
  ...
  return exceptions.filter(({ code }) => offenceExceptions.includes(code))
}

export default getOffenceExceptions
