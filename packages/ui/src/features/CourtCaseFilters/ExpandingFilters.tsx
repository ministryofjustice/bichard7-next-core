...
const ExpandingFilters: React.FC<Props> = ({ children, classNames, filterName }: Props) => {
  ...
  return (
    <fieldset className="govuk-fieldset">
      ...
      >
        <IconButton aria-label={`${filterName} filter options`} className={`icon-button ${classNames}`} type="button">
