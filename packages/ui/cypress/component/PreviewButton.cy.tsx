...
describe("PreviewButton", () => {
  it("shows the preview button with a down pointing chevron when hidden", () => {
    cy.mount(
      <PreviewButton previewLabel="Preview" ariaControls="trigger-preview" onClick={() => {}} showPreview={true} />
    )
  ...
  it("shows the preview button with an up pointing chevron when expanded", () => {
    cy.mount(
      <PreviewButton previewLabel="Preview" ariaControls="trigger-preview" onClick={() => {}} showPreview={false} />
    )
    cy.get(".govuk-accordion-nav__chevron").should("exist")
