...
describe("NextHearingLocation", () => {
  ...
  it("Shouldn't see next hearing location field when it has no value", () => {
    ...
    cy.contains("dt", "Next hearing location").should("not.exist")
  })
  ...
  it("Should be able to edit field if HO100300 is raised", () => {
    ...
    cy.contains("dt", "Next hearing location").siblings().should("include.text", "B46AM03")
    cy.contains("dt", "Next hearing location").siblings().get(".moj-badge").contains("Initial Value")
    cy.contains("dt", "Next hearing location").siblings().should("include.text", "B46DB00")
    cy.contains("dt", "Next hearing location").siblings().get(".moj-badge").contains("Correction")
  })
  ...
  it("Should be able to edit multiple next hearing locations", () => {
    ...
    cy.contains("dt", "Next hearing location").siblings().should("include.text", "")
    cy.contains("dt", "Next hearing location").siblings().get(".moj-badge").contains("Initial Value")
    cy.contains("dt", "Next hearing location").siblings().should("include.text", "B21XA00")
    cy.contains("dt", "Next hearing location").siblings().get(".moj-badge").contains("Correction")
  })
  ...
  it("Should be able to edit multiple hearing results with incorrect next hearing location exceptions", () => {
    ...
    cy.get(".hearing-result-2")
      .contains("dt", "Next hearing location")
      .siblings()
