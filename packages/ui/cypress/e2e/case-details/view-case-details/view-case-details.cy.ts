...
describe("View case details", () => {
  ...
  it("Should display the content of the Defendant tab", () => {
    ...
    clickTab("Defendant")
    cy.contains("th", "ASN").siblings().contains("1101ZD0100000448754K")
  ...
  it("Should display the content of the Offences tab", () => {
    ...
    cy.contains("th:visible", "Title")
      .siblings()
      .contains("Attempt to rape a girl aged 13 / 14 / 15 years of age - SOA 2003")
    cy.contains("th", "Category").siblings().contains("CI (indictable)")
    cy.contains("th", "Arrest date").siblings().contains("01/12/2010")
    cy.contains("th", "Charge date").siblings().contains("02/12/2010")
    cy.contains("th", "Start date").siblings().should("contain.text", "On or in")
    cy.contains("th", "Start date").siblings().should("contain.text", "28/11/2010")
    cy.contains("th", "Start date").siblings().should("contain.text", "Date code: 1")
    cy.contains("th", "Location").siblings().contains("Kingston High Street")
    cy.contains("th", "Wording")
      .siblings()
      .contains("Attempt to rape a girl aged 13 / 14 / 15 / years of age - SOA 2003.")
    cy.contains("th", "Record on PNC").siblings().contains("Y")
    ...
    cy.contains("th", "Mode of trial reason").siblings().contains("SUM")
    cy.contains("th", "Hearing result text").siblings().contains("Travel Restriction Order")
    cy.contains("th", "PNC disposal type").siblings().contains("3078")
    cy.contains("th", "Result class").siblings().contains("Judgement with final result")
    ...
    cy.contains("th:visible", "Title").siblings().contains("Rape a girl aged 13 / 14 / 15 - SOA 2003")
    cy.contains("th", "Category").siblings().contains("CI (indictable)")
    cy.contains("th", "Arrest date").siblings().contains("01/12/2010")
    cy.contains("th", "Charge date").siblings().contains("02/12/2010")
    cy.contains("th", "Start date").siblings().should("contain.text", "On or in")
    ...
    cy.contains("th", "Start date").siblings().should("contain.text", "Date code: 1")
    cy.contains("th", "Location").siblings().contains("Kingston High Street")
    cy.contains("th", "Wording").siblings().contains("Rape of a Female")
    cy.contains("th", "Record on PNC").siblings().contains("Y")
    cy.contains("th", "Notifiable to Home Office").siblings().contains("Y")
    ...
    cy.contains("th", "Result hearing date").siblings().contains("26/09/2011")
    cy.contains("th", "Mode of trial reason").siblings().contains("SUM")
    cy.contains("th", "Hearing result text").siblings().contains("defendant must never be allowed out")
    cy.contains("th", "PNC disposal type").siblings().contains("3052")
    cy.contains("th", "Result class").siblings().contains("Judgement with final result")
    cy.contains("th", "PNC adjudication exists").siblings().contains("N")
    cy.contains("th", "Urgent").siblings().contains("Y")
    ...
    cy.contains("th", "Category").siblings().contains("CM (summary motoring)")
    cy.contains("th", "Arrest date").siblings().contains("01/12/2010")
    cy.contains("th", "Charge date").siblings().contains("02/12/2010")
    cy.contains("th", "Start date").siblings().should("contain.text", "On or in")
    cy.contains("th", "Start date").siblings().should("contain.text", "28/11/2010")
    cy.contains("th", "Start date").siblings().should("contain.text", "Date code: 1")
    cy.contains("th", "Location").siblings().contains("Kingston High Street")
    cy.contains("th", "Wording").siblings().contains("Use a motor vehicle without third party insurance.")
    cy.contains("th", "Record on PNC").siblings().contains("N")
    ...
    cy.contains("th", "Result hearing date").siblings().contains("26/09/2011")
    cy.contains("th", "Mode of trial reason").siblings().contains("SUM")
    cy.contains("th", "Hearing result text").siblings().contains("Fined 100.")
