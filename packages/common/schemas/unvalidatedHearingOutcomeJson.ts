...
export const actualOffenceEndDateSchema = z.object({
  EndDate: z.string().meta({ format: "date" }).describe(offenceDescription.ActualOffenceEndDate.EndDate.$description)
})
...
export const actualOffenceStartDateSchema = z.object({
  StartDate: z
    .string()
    .meta({ format: "date" })
    .describe(offenceDescription.ActualOffenceStartDate.StartDate.$description)
})
...
export const dateSpecifiedInResultSchema = z.object({
  Date: z.string().meta({ format: "date" }).describe(resultDescription.DateSpecifiedInResult.Date.$description),
...
export const sourceReferenceSchema = z.object({
  ...
  SellByDate: z.string().meta({ format: "date" }).optional(),
...
export const hearingSchema = z.object({
  ...
  DateOfHearing: z.string().meta({ format: "date" }).describe(hearingDescription.DateOfHearing.$description),
  ...
  ReportRequestedDate: z.string().meta({ format: "date" }).optional(),
  ReportCompletedDate: z.string().meta({ format: "date" }).optional(),
...
export const resultSchema = z.object({
  ...
  ResultHearingDate: z
    ...
    .meta({ format: "date" })
    .optional()
    .describe(resultDescription.ResultHearingDate.$description),
  ...
  WarrantIssueDate: z
    ...
    .meta({ format: "date" })
    .optional()
    .describe(resultDescription.WarrantIssueDate.$description),
...
export const offenceSchema = z.object({
  ...
  ArrestDate: z.string().meta({ format: "date" }).optional().describe(offenceDescription.ArrestDate.$description),
  ChargeDate: z.string().meta({ format: "date" }).optional().describe(offenceDescription.ChargeDate.$description),
  ...
  ConvictionDate: z
    ...
    .meta({ format: "date" })
    .optional()
    .describe(offenceDescription.ConvictionDate.$description),
...
export const pncAdjudicationSchema = z.object({
  ...
  plea: z.string(),
  sentenceDate: z.string().meta({ format: "date" }).optional(),
  verdict: z.string(),
...
export const pncOffenceSchema = z.object({
  ...
  offence: z.object({
    ...
    endDate: z.string().meta({ format: "date" }).optional(),
    endTime: z.string().optional(),
    qualifier1: z.string().optional(),
    qualifier2: z.string().optional(),
    sequenceNumber: z.number(),
    startDate: z.string().meta({ format: "date" }),
...
export const unvalidatedHearingOutcomeSchemaJson = z.object({
  ...
  PncQueryDate: z
    ...
    .meta({ format: "date" })
    .optional()
    .describe(ahoDescription.AnnotatedHearingOutcome.PncQueryDate.$description),
