...
describe("HO100228 and HO100239", () => {
  ...
  it("should not throw an exception for a valid CourtOffenceSequenceNumber", async () => {
  ...
  it("should create an exception if the CourtOffenceSequenceNumber is less than the min length", async () => {
    const inputMessage = generateSpiMessage({
  ...
  it("should create an exception if the CourtOffenceSequenceNumber is greater than the max length", async () => {
    const inputMessage = generateSpiMessage({
