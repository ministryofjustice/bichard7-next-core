...
/*
  return empty when PncOperations is not in hearingOutcome
  return empty when PncOperations is empty
  return empty when all PncOperations are non NEWREM
  return 1 trigger when PncOperations has one NEWREM
  return 1 trigger when PncOperations has multiple NEWREMs
