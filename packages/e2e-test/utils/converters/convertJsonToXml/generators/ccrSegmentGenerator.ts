import type { DisposalExtended } from "../../../../types/AsnQueryResponseExtended"
import {
...
const ccrSegmentGenerator = (updateType: string | undefined, disposal: DisposalExtended): string => {
