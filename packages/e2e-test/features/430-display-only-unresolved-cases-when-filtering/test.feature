Feature: 430 - Display correct cases when filtered with reason codes in the Next UI

			"""
		When Reason-codes filter is applied then show only the unresolved cases with that reason code
			"""
