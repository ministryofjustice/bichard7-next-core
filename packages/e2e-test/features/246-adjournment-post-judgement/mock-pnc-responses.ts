...
export default (_: string, { policeApi }: Bichard) => [
  policeApi.mockAsnQuery({
    ...
    response: {
      ...
      personId: "e886afbb-6ac7-4df2-afcb-b4d7de618414",
      personUrn: "21/21R",
      reportId: "44a885bd-d5cd-4443-b8be-96e1277791d7",
      asn: "1201ZD0100000445746P",
      ownerCode: "01ZD",
      disposals: [
        {
          crimeOffenceReferenceNumber: "",
          courtCaseId: "b34267b0-c5ce-4b18-985a-a611bf8e0eac",
  ...
  policeApi.mockAsnQuery({
    ...
    response: {
      ...
      personId: "988959b7-ce50-4a80-9dee-ebc64271f0b3",
      personUrn: "21/21R",
      reportId: "d1d6adad-878c-45a1-b18b-c2aa189673e7",
      asn: "1201ZD0100000445746P",
      ownerCode: "01ZD",
      disposals: [
        {
          crimeOffenceReferenceNumber: "",
          courtCaseId: "49804935-f97f-4f83-a8ea-0cfdc4cf12ed",
          courtCaseReference: "21/2732/000016Z",
          caseStatusMarker: "impending-prosecution-detail",
          court: {
            courtIdentityType: "code",
